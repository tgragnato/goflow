...
type FlowMessage struct {
	...
	SrcAsn          string `protobuf:"bytes,1003,opt,name=src_asn,json=srcAsn,proto3" json:"src_asn,omitempty"`
	DstAsn          string `protobuf:"bytes,1004,opt,name=dst_asn,json=dstAsn,proto3" json:"dst_asn,omitempty"`
...
func (x *FlowMessage) GetSrcAsn() string {
	if x != nil {
		return x.SrcAsn
	}
	return ""
...
func (x *FlowMessage) GetDstAsn() string {
	if x != nil {
		return x.DstAsn
	}
	return ""
...
var file_pb_flow_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x6e, 0x18, 0xeb, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x72, 0x63, 0x41,
	0x73, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x64, 0x73, 0x74, 0x5f, 0x61, 0x73, 0x6e, 0x18, 0xec, 0x07,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x64, 0x73, 0x74, 0x41, 0x73, 0x6e, 0x12, 0x2a, 0x0a, 0x10,
