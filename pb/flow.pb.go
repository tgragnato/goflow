...
const file_flow_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"flow.proto\x12\x06flowpb\"\xd6\x11\n" +
	"\vFlowMessage\x120\n" +
	...
	"dstCountry\x12)\n" +
	"\x10lms_target_index\x18\xea\a \x01(\tR\x0elmsTargetIndex\x12\x18\n" +
	"\asrc_asn\x18\xeb\a \x01(\tR\x06srcAsn\x12\x18\n" +
	"\adst_asn\x18\xec\a \x01(\tR\x06dstAsn\x12*\n" +
	"\x10sampler_hostname\x18\xed\a \x01(\tR\x0fsamplerHostname\x12%\n" +
	"\x0eas_path_string\x18\xee\a \x01(\tR\fasPathString\x12\x1f\n" +
	"\vas_path_beg\x18\xef\a \x01(\rR\tasPathBeg\x12\x1f\n" +
	"\vas_path_end\x18\xf0\a \x01(\rR\tasPathEnd\"S\n" +
	"\bFlowType\x12\x0f\n" +
	...
	"\x06Teredo\x10\r\x12\n" +
	"\n" +
	"\x06Custom\x10cB\x1fZ\x1dtgragnato.it/goflow/pb;flowpbb\x06proto3"
